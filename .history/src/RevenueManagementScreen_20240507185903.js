    ...
    const unsubscribe = firestore()
      ...
      .onSnapshot(querySnapshot => {
        ...
        querySnapshot.forEach(async doc => {
          ...
          // Truy vấn vào Firestore để lấy tên phim từ movieId
          const movieRef = firestore().collection('ticket').orderBy('movieId','desc');
          const movieDoc = await movieRef.get();
          const movieTitle = movieDoc.exists ? movieDoc.data().movieTitle : 'Unknown Movie';
