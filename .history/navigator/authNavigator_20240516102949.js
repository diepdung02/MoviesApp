...
import {Login, Register, ForgotPassword, Account, HomeScreen, MovieDetailScreen, NowShowingScreen, ChooseTimeScreen, MyTicketsScreen, Profile} from '../screen';
  ...
  return (
    <NavigationContainer>
      ...
      <Stack.Screen name="Register" component={Register} />
        ...
        <Stack.Screen name="Profile" component={MyTicketsScreen} />
      </Stack.Navigator>
    </NavigationContainer>
  );
}
