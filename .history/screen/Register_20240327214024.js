  ...
  return (
    <Formik
      ...
      validationSchema={Yup.object().shape({
        ...
        confirmPassword: Yup.string().oneOf([Yup.ref('password'), null], 'Xác nhận mật khẩu không khớp').required('Vui lòng xác nhận mật khẩu'),
      })}
      ...
      {({values, touched, errors, handleChange, handleSubmit, handleBlur}) => (
        <View style={styles.container}>
          ...
          <TouchableOpacity onPress={() => navigation.navigate('Login')}>
            <Text style={styles.TextRegister}>Đã có tài khoản? Đăng nhập ngay</Text>
          </TouchableOpacity>
        </View>
      )}
    </Formik>
