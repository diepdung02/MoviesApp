...
const BookingScreen = () => {
  ...
  // Lưu trạng thái ghế đã đặt vào Firestore trong collection của người dùng
  firestore()
    .collection('users')
    .doc(userEmail)
    .collection('reserved_seats') // Thay đổi collection thành 'reserved_seats'
    .doc(`${seat.row}${seat.number}`) // Đặt tên tài liệu là số ghế
    .set(ticketData) // Sử dụng set() thay vì add()
