...
const styles = StyleSheet.create({
  container: {
    ...
    alignItems: 'center',
    padding: 20,
    backgroundColor: '#F5FCFF', // Thay đổi màu nền
  },
  header: {
    fontSize: 24,
    fontWeight: 'bold',
  ...
  seat: {
    width: 40, // Thay đổi kích thước ghế
    height: 40, // Thay đổi kích thước ghế
    justifyContent: 'center',
    alignItems: 'center',
    borderWidth: 1,
    borderColor: 'black',
  ...
  lockedSeat: {
    backgroundColor: '#808080', // Thay đổi màu sắc ghế đã khóa
  },
  bookButton: {
    backgroundColor: '#4CAF50', // Thay đổi màu sắc nút "Đặt vé"
    padding: 10,
    borderRadius: 5,
    alignItems: 'center',
    marginTop: 20,
