...
const BookingScreen = () => {
  ...
  function getPrice(type) {
    ...
    if (movie) {
      switch (type) {
        case 'VIP':
          return movie.vipPrice ? parseFloat(movie.vipPrice) : 0;
        case 'Low':
          return movie.lowPrice ? parseFloat(movie.lowPrice) : 0;
        default:
          return movie.normalPrice ? parseFloat(movie.normalPrice) : 0;
      }
    }
    return 0;
  }
