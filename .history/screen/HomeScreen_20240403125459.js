...
const HomeScreen = ({navigation}) => {
  ...
  const [selectedButton, setSelectedButton] = useState('NowShowing'); // Tạo state cho nút được chọn
      ...
      <View style={styles.container}>
        ...
        <View style={styles.buttonsContainer}>
          <TouchableOpacity
            style={[
              styles.button,
              selectedButton === 'TrendingMovies' && styles.selectedButton,
            ]} // Sử dụng điều kiện để cung cấp màu khác nhau cho nút được chọn
          ...
          <TouchableOpacity
            style={[
              styles.button,
              selectedButton === 'NowShowing' && styles.selectedButton,
            ]}
