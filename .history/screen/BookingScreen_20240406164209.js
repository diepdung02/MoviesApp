...
const BookingScreen = () => {
  ...
  const handlePayment = async () => {
    try {
      // Truy vấn dữ liệu từ Firestore để lấy selectedShowtime
      ...
      const selectedShowtime = movieData.selectedShowtime;
  
      console.log("Selected showtime:", selectedShowtime); // Kiểm tra giá trị của selectedShowtime
  
      // Navigation đến PaymentScreen với các thông tin cần thiết
      ...
      console.error("Error fetching selected showtime:", error);
    }
  };
